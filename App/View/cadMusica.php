...
<body>
    ...
    <div class="w3-container w3-card-4 w3-margin">
        ...
        <form method="post"
            ...
            <br><br>
            <!-- Link do áudio -->
            <label for="musLinkAudio">Link Áudio:</label>
            <input type="text" id="musLinkAudio"
                name="musLinkAudio" value="<?php echo $musica['musLinkAudio']; ?>"
                size="100">
            <br><br>
            <!-- Categorias -->
