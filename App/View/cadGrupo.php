...
<body>
    ...
    <div class="w3-container w3-card-4 w3-margin">
        ...
        <form method="post"
            ...
            <br><br>
            <!-- Data do Ensaio-->
            <label for="gruDataEnsaio">Data do Ensaio:</label>
            <input type="date" id="gruDataEnsaio"
                name="gruDataEnsaio" value="<?php echo $grupo['gruDataEnsaio']; ?>">
            <br><br>
            <!-- Observações -->
